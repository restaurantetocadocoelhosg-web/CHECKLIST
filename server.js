...
app.post('/api/ping',(req,res)=>{const{user_id,user_name}=req.body;db.prepare('INSERT INTO activity_log (user_id,user_name,date,time,action) VALUES (?,?,?,?,?)').run(user_id,user_name,today(),nowTime(),'ping');res.json({ok:true});});
